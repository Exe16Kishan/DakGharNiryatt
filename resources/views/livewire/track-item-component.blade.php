<div class="container my-4">
    <h2 class="track-item-heading">
        Track Your Item 
        <i class="fa-solid fa-magnifying-glass fa-flip-horizontal text-muted"></i>
    </h2>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="trackItem">                            
                        <div class="input-group">
                            ...
                            >
                            <button 
                                id="track-item-submit" 
                                class="btn btn-primary" 
                                type="submit"
                            >
                                Track
                                <i wire:loading class="fa-solid  fa-spin ms-1"></i>
                            </button>
                        </div>
                        ...
                        @error('tracking_number')
                            @foreach ($errors->get('tracking_number') as $error)
                                ...
                                @else
                                    <div class="invalid-feedback d-block mt-1 animate__animated animate__fadeIn">
                                        {{ $error }}
                                    </div>
                                @endif
                            @endforeach
